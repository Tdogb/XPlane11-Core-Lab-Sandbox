...
# parser.add_argument("--device", required=False, help="serial device", default='/dev/tty.usbmodem2040366246531')
...
parser.add_argument("--baudrate", type=int,
                  help="master port baud rate", default=115200)
parser.add_argument("--device", required=False, default="/dev/tty.usbmodem01", help="serial device")
